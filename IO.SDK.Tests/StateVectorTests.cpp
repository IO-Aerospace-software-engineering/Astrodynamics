...
TEST(StateVector, Initialization)
{
	...
	IO::SDK::OrbitalParameters::StateVector sv(earth, IO::SDK::Math::Vector3D(1.0, 2.0, 3.0), IO::SDK::Math::Vector3D(4.0, 5.0, 6.0), IO::SDK::Time::TDB(100.0s), IO::SDK::Frames::InertialFrames::ICRF);
	...
	IO::SDK::OrbitalParameters::StateVector svFromState(earth, state, IO::SDK::Time::TDB(100.0s), IO::SDK::Frames::InertialFrames::ICRF);
...
TEST(StateVector, GetSpecificAngularMomentum)
{
	...
	IO::SDK::OrbitalParameters::StateVector sv(sun, IO::SDK::Math::Vector3D(149.6e9, 0.0, 0.0), IO::SDK::Math::Vector3D(0.0, 2.98e4, 0.0), IO::SDK::Time::TDB(0.0s), IO::SDK::Frames::InertialFrames::ICRF);
...
TEST(StateVector, GetSpecificOrbitalEnergy)
{
	...
	IO::SDK::OrbitalParameters::StateVector sv(earth, IO::SDK::Math::Vector3D(-6.116559469556896E+06, -1.546174698676721E+06, 2.521950157430313E+06), IO::SDK::Math::Vector3D(-8.078523150700097E+02, -5.477647950892673E+03, -5.297615757935174E+03), IO::SDK::Time::TDB(663724800.00001490s), IO::SDK::Frames::InertialFrames::ICRF);
...
TEST(StateVector, IsHyperbolic)
{
	//ISS
	auto earth = std::make_shared<IO::SDK::Body::CelestialBody>(399, "earth"); //GEOPHYSICAL PROPERTIES provided by JPL
	IO::SDK::OrbitalParameters::StateVector sv(earth, IO::SDK::Math::Vector3D(6800000.0, 0.0, 0.0), IO::SDK::Math::Vector3D(0.0, 18000.0, 0.0), IO::SDK::Time::TDB(663724800.00001490s), IO::SDK::Frames::InertialFrames::ICRF);
...
TEST(StateVector, IsParabolic)
{
	...
	IO::SDK::OrbitalParameters::StateVector sv(earth, IO::SDK::Math::Vector3D(6800000.0, 0.0, 0.0), IO::SDK::Math::Vector3D(0.0, escapeVelocity, 0.0), IO::SDK::Time::TDB(663724800.00001490s), IO::SDK::Frames::InertialFrames::ICRF);
...
TEST(StateVector, CheckUpdateCenterOfMotionToParentBody)
{
	...
	IO::SDK::OrbitalParameters::StateVector sv{earth, IO::SDK::Math::Vector3D(2000000000.0, 0.0, 0.0), IO::SDK::Math::Vector3D(0.0, 3000.0, 0.0), IO::SDK::Time::TDB(662731200.000000s), IO::SDK::Frames::InertialFrames::ICRF};
...
TEST(StateVector, CheckUpdateCenterOfMotionToSatelliteBody)
{
	...
	IO::SDK::OrbitalParameters::StateVector sv{earth, IO::SDK::Math::Vector3D(-2.088864826237993E+08, 2.911146390982051E+08, 1.515746884380044E+08), IO::SDK::Math::Vector3D(-8.366764389833921E+02, -5.602543663174073E+02, -1.710459390585548E+02), IO::SDK::Time::TDB(662731200.000000s), IO::SDK::Frames::InertialFrames::ICRF};
	auto newSV = sv.CheckAndUpdateCenterOfMotion();
...
TEST(StateVector, Assignement)
{
	...
	//Define SV with earth as center of motion but the influence body is the moon in this case at 2021-01-01 00:00:00.000000 TDB
	IO::SDK::OrbitalParameters::StateVector sv{earth, IO::SDK::Math::Vector3D(1.0, 2.0, 3.0), IO::SDK::Math::Vector3D(4.0, 5.0, 6.0), IO::SDK::Time::TDB(100.0s), IO::SDK::Frames::InertialFrames::ICRF};
	IO::SDK::OrbitalParameters::StateVector sv2{earth, IO::SDK::Math::Vector3D(10.0, 20.0, 30.0), IO::SDK::Math::Vector3D(40.0, 50.0, 60.0), IO::SDK::Time::TDB(1000.0s), IO::SDK::Frames::InertialFrames::ICRF};
	sv2 = sv;
...
{
	auto earth = std::make_shared<IO::SDK::Body::CelestialBody>(399, "earth"); //GEOPHYSICAL PROPERTIES provided by JPL
	const IO::SDK::OrbitalParameters::StateVector sv(earth, IO::SDK::Math::Vector3D(6800000.0, 0.0, 0.0), IO::SDK::Math::Vector3D(0.0, 18000.0, 0.0), IO::SDK::Time::TDB(663724800.00001490s), IO::SDK::Frames::InertialFrames::ICRF);

	//Low accuracy due to conical propagation
	ASSERT_EQ(IO::SDK::Frames::InertialFrames::ICRF, sv.GetFrame());
...
{
	auto earth = std::make_shared<IO::SDK::Body::CelestialBody>(399, "earth"); //GEOPHYSICAL PROPERTIES provided by JPL
	const IO::SDK::OrbitalParameters::StateVector sv(earth, IO::SDK::Math::Vector3D(6800000.0, 0.0, 0.0), IO::SDK::Math::Vector3D(0.0, 9000.0, 0.0), IO::SDK::Time::TDB(663724800.00001490s), IO::SDK::Frames::InertialFrames::ICRF);
...
{
	auto earth = std::make_shared<IO::SDK::Body::CelestialBody>(399, "earth"); //GEOPHYSICAL PROPERTIES provided by JPL
	const IO::SDK::OrbitalParameters::StateVector sv(earth, IO::SDK::Math::Vector3D(6800000.0, 0.0, 0.0), IO::SDK::Math::Vector3D(0.0, 9000.0, 0.0), IO::SDK::Time::TDB(0.0s), IO::SDK::Frames::InertialFrames::ICRF);
...
{
	auto sun = std::make_shared<IO::SDK::Body::CelestialBody>(10, "sun"); //GEOPHYSICAL PROPERTIES provided by JPL
	const IO::SDK::OrbitalParameters::StateVector sv(sun, IO::SDK::Math::Vector3D(-2.649903367743050E+10,1.327574173383451E+11, 5.755671847054072E+10), IO::SDK::Math::Vector3D(-2.979426007043741E+04, -5.018052308799903E+03, -2.175393802830554E+03), IO::SDK::Time::TDB(0.0s), IO::SDK::Frames::InertialFrames::ICRF);
...
{
	auto earth = std::make_shared<IO::SDK::Body::CelestialBody>(399, "earth"); //GEOPHYSICAL PROPERTIES provided by JPL
	const IO::SDK::OrbitalParameters::StateVector sv(earth, IO::SDK::Math::Vector3D(6800000.0, 0.0, 0.0), IO::SDK::Math::Vector3D(0.0, 9000.0, 1000.0), IO::SDK::Time::TDB(0.0s), IO::SDK::Frames::InertialFrames::ICRF);
