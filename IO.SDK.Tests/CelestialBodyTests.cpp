...
TEST(CelestialBody, FindDistanceConstraint)
{
	...
	auto results = earth->FindWindowsOnDistanceConstraint(searchWindow, *moon, *earth, IO::SDK::Constraints::RelationnalOperator::GreaterThan(), IO::SDK::AberrationsEnum::None, 400000000.0, IO::SDK::Time::TimeSpan(86400s));
