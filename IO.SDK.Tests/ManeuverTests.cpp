...
TEST(Maneuvers, Initialization)
{
    ...
    TestManeuver m_first(engines, s, &prop);

    TestManeuver m_second(engines, s, &prop);
}
...
TEST(Maneuvers, Execute)
{
    ...
    pro.AddStateVector(IO::SDK::OrbitalParameters::StateVector(earth, IO::SDK::Math::Vector3D(1.0, 2.0, 3.0), IO::SDK::Math::Vector3D(4.0, 5.0, 6.0), IO::SDK::Time::TDB(100.0s),IO::SDK::Frames::InertialFrames::ICRF));
    pro.AddStateVector(IO::SDK::OrbitalParameters::StateVector(earth, IO::SDK::Math::Vector3D(1.0, 2.0, 3.0), IO::SDK::Math::Vector3D(4.0, 5.0, 6.0), IO::SDK::Time::TDB(110.0s),IO::SDK::Frames::InertialFrames::ICRF));
    pro.AddStateVector(IO::SDK::OrbitalParameters::StateVector(earth, IO::SDK::Math::Vector3D(1.0, 2.0, 3.0), IO::SDK::Math::Vector3D(4.0, 5.0, 6.0), IO::SDK::Time::TDB(120.0s),IO::SDK::Frames::InertialFrames::ICRF));
    pro.AddStateVector(IO::SDK::OrbitalParameters::StateVector(earth, IO::SDK::Math::Vector3D(1.0, 2.0, 3.0), IO::SDK::Math::Vector3D(4.0, 5.0, 6.0), IO::SDK::Time::TDB(130.0s),IO::SDK::Frames::InertialFrames::ICRF));
    pro.AddStateVector(IO::SDK::OrbitalParameters::StateVector(earth, IO::SDK::Math::Vector3D(1.0, 2.0, 3.0), IO::SDK::Math::Vector3D(4.0, 5.0, 6.0), IO::SDK::Time::TDB(140.0s),IO::SDK::Frames::InertialFrames::ICRF));
    pro.AddStateVector(IO::SDK::OrbitalParameters::StateVector(earth, IO::SDK::Math::Vector3D(1.0, 2.0, 3.0), IO::SDK::Math::Vector3D(4.0, 5.0, 6.0), IO::SDK::Time::TDB(150.0s),IO::SDK::Frames::InertialFrames::ICRF));
    ...
    TestManeuver maneuver(engines, s, &pro);

    maneuver.Handle(IO::SDK::Time::TDB(100.0s));

    IO::SDK::OrbitalParameters::StateVector maneuverPoint(earth, IO::SDK::Math::Vector3D(1.0, 2.0, 3.0), IO::SDK::Math::Vector3D(4.0, 5.0, 6.0), IO::SDK::Time::TDB(130.0s),IO::SDK::Frames::InertialFrames::ICRF);
