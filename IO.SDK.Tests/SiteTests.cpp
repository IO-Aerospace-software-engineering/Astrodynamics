...
TEST(Site, FindWindowsOnIlluminationConstraint) {
    ...
    auto windows = s.FindWindowsOnIlluminationConstraint(
            ...
            IO::SDK::IlluminationAngle::Incidence(), IO::SDK::Constraint::LowerThan(), IO::SDK::Constants::PI2 - IO::SDK::Constants::OfficialTwilight);
...
//
//    //Position virtual station on same location as DSS-13 at local noon
//    IO::SDK::Sites::Site s{333017, "FK_DSS-13",
//                           IO::SDK::Coordinates::Geodetic(-116.7944627147624 * IO::SDK::Constants::DEG_RAD, 35.2471635434595 * IO::SDK::Constants::DEG_RAD, 107.0), earth};
//
...
//
//
//    //expected 2023-02-19 12:22:05.678445 UTC
//    //
//    //2023-02-19 22:32:23.152776 UTC
//    //
//    //36617.47433138
...
//    ASSERT_EQ(1, windows.size());
//    ASSERT_STREQ("2023-02-19 12:22:05.678445 (UTC)", windows[0].GetStartDate().ToTDB().ToString().c_str());
//    ASSERT_STREQ("2023-02-19 22:32:23.152776", windows[0].GetEndDate().ToString().c_str());
//
//}
