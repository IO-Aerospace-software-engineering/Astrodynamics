...
#ifdef _WIN32
    ASSERT_DOUBLE_EQ(14.039767793790361, maneuver.GetDeltaV().Magnitude());
    ASSERT_DOUBLE_EQ(-0.0014039767698486689, maneuver.GetDeltaV().GetX());
    ASSERT_DOUBLE_EQ(14.039767723591522, maneuver.GetDeltaV().GetY());
    ASSERT_DOUBLE_EQ(8.5968782802421451e-16, maneuver.GetDeltaV().GetZ());
