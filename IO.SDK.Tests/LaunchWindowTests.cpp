...
{
    IO::SDK::Scenario sc("scenario1", IO::SDK::Time::Window<IO::SDK::Time::UTC>(IO::SDK::Time::UTC(10.0s), IO::SDK::Time::UTC(20.0s)));
    auto sun = std::make_shared<IO::SDK::Body::CelestialBody>(10, "sun");
    auto earth = std::make_shared<IO::SDK::Body::CelestialBody>(399, "earth", sun);
    auto ls = std::make_shared<IO::SDK::Sites::LaunchSite>(1, sc, "S1", IO::SDK::Coordinates::Geodetic(81.0 * IO::SDK::Constants::DEG_RAD, 28.5 * IO::SDK::Constants::DEG_RAD, 0.0),
                                                           earth);
...
{
    IO::SDK::Time::Window<IO::SDK::Time::UTC>(IO::SDK::Time::UTC(10.0s), IO::SDK::Time::UTC(50.0s));
