...
IO::Astrodynamics::OrbitalParameters::StateVector::StateVector(
    const std::shared_ptr<IO::Astrodynamics::Body::CelestialBody>& centerOfMotion,
    const IO::Astrodynamics::Math::Vector3D& position,
    const IO::Astrodynamics::Math::Vector3D& velocity, const IO::Astrodynamics::Time::TDB& epoch,
    const IO::Astrodynamics::Frames::Frames& frame)
    : OrbitalParameters(centerOfMotion, epoch, frame), m_position{position}, m_velocity{velocity},
...
IO::Astrodynamics::OrbitalParameters::StateVector::StateVector(
    const std::shared_ptr<IO::Astrodynamics::Body::CelestialBody>& centerOfMotion, double state[6],
    const IO::Astrodynamics::Time::TDB& epoch,
    const IO::Astrodynamics::Frames::Frames& frame) : StateVector(centerOfMotion,
...
IO::Astrodynamics::OrbitalParameters::StateVector::StateVector(const StateVector& v) :
    OrbitalParameters(v.m_centerOfMotion, v.m_epoch, v.m_frame), m_position{v.m_position},
...
IO::Astrodynamics::OrbitalParameters::StateVector& IO::Astrodynamics::OrbitalParameters::StateVector::operator=(
...
IO::Astrodynamics::OrbitalParameters::StateVector IO::Astrodynamics::OrbitalParameters::StateVector::ToStateVector(
    const IO::Astrodynamics::Time::TDB& epoch) const
{
    SpiceDouble state[6]{
        m_position.GetX(), m_position.GetY(), m_position.GetZ(), m_velocity.GetX(), m_velocity.GetY(), m_velocity.GetZ()
    };
...
bool IO::Astrodynamics::OrbitalParameters::StateVector::operator==(
    const IO::Astrodynamics::OrbitalParameters::StateVector& other) const
{
    return m_velocity == other.m_velocity && m_position == other.m_position && m_momentum == other.m_momentum && m_epoch
        == other.m_epoch;
}
...
{
    return StateVector{
        m_centerOfMotion, m_position - other.m_position, m_velocity - other.m_velocity, m_epoch, m_frame
    };
}
...
IO::Astrodynamics::OrbitalParameters::StateVector
IO::Astrodynamics::OrbitalParameters::StateVector::ToStateVector() const
{
    return *this;
}
