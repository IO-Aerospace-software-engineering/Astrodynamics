...
namespace IO::Astrodynamics::Propagators
{
    ...
    public:
         ...
         */
        Propagator(const IO::Astrodynamics::Body::Spacecraft::Spacecraft &spacecraft, const IO::Astrodynamics::Integrators::IntegratorBase &integrator,
        ...
        /**
         * Get a reference to integrator
         * @return
         */
        inline IO::Astrodynamics::Integrators::IntegratorBase &GetIntegrator()
        { return m_integrator; }
         ...
         * @return
         */
        inline IO::Astrodynamics::OrbitalParameters::StateVector &GetLatestStateVector()
        { return m_stateVectors.back(); }
    };
