...
IO::Astrodynamics::Maneuvers::Attitudes::ZenithAttitude::ZenithAttitude(const std::vector<IO::Astrodynamics::Body::Spacecraft::Engine *> &engines,
                                                                        IO::Astrodynamics::Propagators::Propagator &propagator,
                                                                        const IO::Astrodynamics::Time::TimeSpan &attitudeHoldDuration) : IO::Astrodynamics::Maneuvers::ManeuverBase(
        engines, propagator,
...
IO::Astrodynamics::Maneuvers::Attitudes::ZenithAttitude::ComputeOrientation(const IO::Astrodynamics::OrbitalParameters::OrbitalParameters &maneuverPoint)
{
    return IO::Astrodynamics::OrbitalParameters::StateOrientation{maneuverPoint.ToStateVector().GetPosition().Normalize().To(m_spacecraft.Front),
