...
TEST(StateVector, Initialization)
{
    ...
    IO::Astrodynamics::OrbitalParameters::StateVector sv(earth, IO::Astrodynamics::Math::Vector3D(1.0, 2.0, 3.0),
    ...
    IO::Astrodynamics::OrbitalParameters::StateVector svFromState(earth, state, IO::Astrodynamics::Time::TDB(100.0s),
                                                                  IO::Astrodynamics::Frames::InertialFrames::ICRF());
...
TEST(StateVector, GetSpecificAngularMomentum)
{
    ...
    IO::Astrodynamics::OrbitalParameters::StateVector sv(sun, IO::Astrodynamics::Math::Vector3D(149.6e9, 0.0, 0.0),
                                                         IO::Astrodynamics::Math::Vector3D(0.0, 2.98e4, 0.0),
...
TEST(StateVector, GetSpecificOrbitalEnergy)
{
    ...
    IO::Astrodynamics::OrbitalParameters::StateVector sv(
        earth, IO::Astrodynamics::Math::Vector3D(-6.116559469556896E+06, -1.546174698676721E+06, 2.521950157430313E+06),
        IO::Astrodynamics::Math::Vector3D(-8.078523150700097E+02, -5.477647950892673E+03, -5.297615757935174E+03),
        IO::Astrodynamics::Time::TDB(663724800.00001490s),
        IO::Astrodynamics::Frames::InertialFrames::ICRF());
...
TEST(StateVector, GetRAN)
{
    ...
    //Low accuracy due to conical propagation
    ASSERT_NEAR(3.257645785453723E+01 * IO::Astrodynamics::Constants::DEG_RAD, sv.GetRightAscendingNodeLongitude(),
                1e-2);
}
...
TEST(StateVector, IsHyperbolic)
{
    //ISS
    auto earth = std::make_shared<IO::Astrodynamics::Body::CelestialBody>(399); //GEOPHYSICAL PROPERTIES provided by JPL
    IO::Astrodynamics::OrbitalParameters::StateVector sv(earth, IO::Astrodynamics::Math::Vector3D(6800000.0, 0.0, 0.0),
                                                         IO::Astrodynamics::Math::Vector3D(0.0, 18000.0, 0.0),
                                                         IO::Astrodynamics::Time::TDB(663724800.00001490s),
                                                         IO::Astrodynamics::Frames::InertialFrames::ICRF());
...
TEST(StateVector, IsParabolic)
{
    ...
    IO::Astrodynamics::OrbitalParameters::StateVector sv(earth, IO::Astrodynamics::Math::Vector3D(6800000.0, 0.0, 0.0),
                                                         IO::Astrodynamics::Math::Vector3D(0.0, escapeVelocity, 0.0),
                                                         IO::Astrodynamics::Time::TDB(663724800.00001490s),
                                                         IO::Astrodynamics::Frames::InertialFrames::ICRF());
...
TEST(StateVector, Assignement)
{
    ...
    //GEOPHYSICAL PROPERTIES provided by JPL
    ...
    IO::Astrodynamics::OrbitalParameters::StateVector sv{
        earth, IO::Astrodynamics::Math::Vector3D(1.0, 2.0, 3.0), IO::Astrodynamics::Math::Vector3D(4.0, 5.0, 6.0),
        IO::Astrodynamics::Time::TDB(100.0s),
        IO::Astrodynamics::Frames::InertialFrames::ICRF()
    };
    IO::Astrodynamics::OrbitalParameters::StateVector sv2{
        earth, IO::Astrodynamics::Math::Vector3D(10.0, 20.0, 30.0), IO::Astrodynamics::Math::Vector3D(40.0, 50.0, 60.0),
        IO::Astrodynamics::Time::TDB(1000.0s),
        IO::Astrodynamics::Frames::InertialFrames::ICRF()
    };
    sv2 = sv;
...
{
    auto earth = std::make_shared<IO::Astrodynamics::Body::CelestialBody>(399); //GEOPHYSICAL PROPERTIES provided by JPL
    const IO::Astrodynamics::OrbitalParameters::StateVector sv(
        earth, IO::Astrodynamics::Math::Vector3D(6800000.0, 0.0, 0.0),
        IO::Astrodynamics::Math::Vector3D(0.0, 18000.0, 0.0), IO::Astrodynamics::Time::TDB(663724800.00001490s),
        IO::Astrodynamics::Frames::InertialFrames::ICRF());
...
TEST(StateVector, EccentricityVector)
{
    ...
    const IO::Astrodynamics::OrbitalParameters::StateVector sv(
        earth, IO::Astrodynamics::Math::Vector3D(6800000.0, 0.0, 0.0),
        IO::Astrodynamics::Math::Vector3D(0.0, 9000.0, 0.0), IO::Astrodynamics::Time::TDB(663724800.00001490s),
        IO::Astrodynamics::Frames::InertialFrames::ICRF());
...
TEST(StateVector, FromTrueAnomaly)
{
    ...
    const IO::Astrodynamics::OrbitalParameters::StateVector sv(
        earth, IO::Astrodynamics::Math::Vector3D(6800000.0, 0.0, 0.0),
        IO::Astrodynamics::Math::Vector3D(0.0, 9000.0, 0.0), IO::Astrodynamics::Time::TDB(0.0s),
        IO::Astrodynamics::Frames::InertialFrames::ICRF());
    ...
    ASSERT_DOUBLE_EQ(IO::Astrodynamics::Constants::PI,
                     newSv.GetPosition().Normalize().GetAngle(newSv.GetPerigeeVector().Normalize()));

    newSv = sv.ToStateVector(IO::Astrodynamics::Constants::PI + IO::Astrodynamics::Constants::PI2);
    ASSERT_DOUBLE_EQ(IO::Astrodynamics::Constants::PI2,
                     newSv.GetPosition().Normalize().GetAngle(newSv.GetPerigeeVector().Normalize()));
}
...
TEST(StateVector, ToFrame)
{
    auto sun = std::make_shared<IO::Astrodynamics::Body::CelestialBody>(10); //GEOPHYSICAL PROPERTIES provided by JPL
    const IO::Astrodynamics::OrbitalParameters::StateVector sv(
        sun, IO::Astrodynamics::Math::Vector3D(-2.649903367743050E+10, 1.327574173383451E+11, 5.755671847054072E+10),
        IO::Astrodynamics::Math::Vector3D(-2.979426007043741E+04, -5.018052308799903E+03, -2.175393802830554E+03),
        IO::Astrodynamics::Time::TDB(0.0s),
        IO::Astrodynamics::Frames::InertialFrames::ICRF());
...
TEST(StateVector, GetAscendingNodeVector)
{
    ...
    const IO::Astrodynamics::OrbitalParameters::StateVector sv(
        earth, IO::Astrodynamics::Math::Vector3D(6800000.0, 0.0, 0.0),
        IO::Astrodynamics::Math::Vector3D(0.0, 9000.0, 1000.0), IO::Astrodynamics::Time::TDB(0.0s),
        IO::Astrodynamics::Frames::InertialFrames::ICRF());

    auto anv = sv.GetAscendingNodeVector();

    ASSERT_NEAR(0.9999999739774097, anv.GetX(), 1e-9);
    ASSERT_NEAR(0.00022673879821807146, anv.GetY(), 1e-9);
    ASSERT_NEAR(2.5193199802008394e-05, anv.GetZ(), 1e-9);
}
