...
TEST(Propagator, Initialization) {
    ...
    IO::Astrodynamics::OrbitalParameters::StateOrientation attitude(IO::Astrodynamics::Time::TDB(100.0s),
                                                                    IO::Astrodynamics::Frames::InertialFrames::ICRF());
    IO::Astrodynamics::Body::Spacecraft::Spacecraft s{-1, "sptest", 1000.0, 3000.0, std::string(SpacecraftPath),
                                                      std::move(orbitalParams)};
    IO::Astrodynamics::Propagators::Propagator pro(s, integrator,
                                                   IO::Astrodynamics::Time::Window(IO::Astrodynamics::Time::TDB(100.0s),
                                                                                   IO::Astrodynamics::Time::TDB(
                                                                                           200.0s)));
}
...
TEST(Propagator, FindNearestLowerValue) {
    ...
    pro.AddStateVector(
            IO::Astrodynamics::OrbitalParameters::StateVector(earth, IO::Astrodynamics::Math::Vector3D(1.0, 2.0, 3.0),
...
TEST(Propagator, PropagateVVIntegrator) {
    ...
    std::unique_ptr<IO::Astrodynamics::OrbitalParameters::OrbitalParameters> orbitalParams = std::make_unique<IO::Astrodynamics::OrbitalParameters::StateVector>(
            ...
            epoch,
            IO::Astrodynamics::Frames::InertialFrames::ICRF());
    IO::Astrodynamics::Body::Spacecraft::Spacecraft spc(-125, "spc125", 1000.0, 3000.0, std::string(SpacecraftPath),
                                                        std::move(orbitalParams));

    IO::Astrodynamics::Propagators::Propagator pro(spc, integrator,
                                                   IO::Astrodynamics::Time::Window(epoch, epoch + step * 100.0));
    ...
    auto ephemerisSv = spc.ReadEphemeris(IO::Astrodynamics::Frames::InertialFrames::ICRF(),
                                         IO::Astrodynamics::AberrationsEnum::None, epoch + step * 80.0, *earth);
...
TEST(Propagator, PropagatorVsKepler) {
    ...
    IO::Astrodynamics::OrbitalParameters::StateOrientation attitude(IO::Astrodynamics::Time::TDB(100.0s),
                                                                    IO::Astrodynamics::Frames::InertialFrames::ICRF());
    IO::Astrodynamics::Body::Spacecraft::Spacecraft spc(-12, "spc12", 1000.0, 3000.0, std::string(SpacecraftPath),
                                                        std::move(orbitalParams));

    IO::Astrodynamics::Propagators::Propagator pro(spc, integrator,
                                                   IO::Astrodynamics::Time::Window(epoch, epoch + duration));
    ...
    ASSERT_NEAR(pro.GetStateVectors()[0].GetSpecificOrbitalEnergy(),
                pro.GetStateVectors()[duration.GetSeconds().count() / step.GetSeconds().count() -
                                      1.0].GetSpecificOrbitalEnergy(), 1E-05);

    ASSERT_NEAR(keplerResults.GetPosition().GetX(), propagationResult.GetPosition().GetX(),
                IO::Astrodynamics::Test::Constants::DISTANCE_ACCURACY);
    ASSERT_NEAR(keplerResults.GetPosition().GetY(), propagationResult.GetPosition().GetY(),
                IO::Astrodynamics::Test::Constants::DISTANCE_ACCURACY);
    ASSERT_NEAR(keplerResults.GetPosition().GetZ(), propagationResult.GetPosition().GetZ(),
                IO::Astrodynamics::Test::Constants::DISTANCE_ACCURACY);

    ASSERT_NEAR(keplerResults.GetVelocity().GetX(), propagationResult.GetVelocity().GetX(),
                IO::Astrodynamics::Test::Constants::VELOCITY_ACCURACY);
    ASSERT_NEAR(keplerResults.GetVelocity().GetY(), propagationResult.GetVelocity().GetY(),
                IO::Astrodynamics::Test::Constants::VELOCITY_ACCURACY);
    ASSERT_NEAR(keplerResults.GetVelocity().GetZ(), propagationResult.GetVelocity().GetZ(),
                IO::Astrodynamics::Test::Constants::VELOCITY_ACCURACY);
...
TEST(Propagator, NodePrecession) {
    ...
    auto orbitalParams = IO::Astrodynamics::OrbitalParameters::OrbitalParameters::CreateEarthHelioSynchronousOrbit(
            earth, 7080636.3, 0.0001724, epoch);
    IO::Astrodynamics::Body::Spacecraft::Spacecraft spc(-127, "spc127", 1000.0, 3000.0, std::string(SpacecraftPath),
                                                        std::move(orbitalParams));

    IO::Astrodynamics::Propagators::Propagator pro(spc, integrator, IO::Astrodynamics::Time::Window(epoch, epoch +
                                                                                                           step *
                                                                                                           86400.0 *
                                                                                                           2.0));
    ...
    auto sv1 = spc.ReadEphemeris(IO::Astrodynamics::Frames::InertialFrames::ICRF(),
    ...
    ASSERT_NEAR(11.457444465360759, sv1.GetRightAscendingNodeLongitude() * IO::Astrodynamics::Constants::RAD_DEG,
                1E-03);
    ...
    //Read ephemeris
    auto sv2 = spc.ReadEphemeris(IO::Astrodynamics::Frames::InertialFrames::ICRF(),
                                 IO::Astrodynamics::AberrationsEnum::None, epoch + (step * 86400.0 * 2.0) - step,
                                 *earth);
    ...
    ASSERT_NEAR(13.230478085368484, sv2.GetRightAscendingNodeLongitude() * IO::Astrodynamics::Constants::RAD_DEG,
                1E-03);
...
TEST(Propagator, PropagatorVsKepler2) {
    ...
    //  VX=-8.366764389833921E-01 VY=-5.602543663174073E-01 VZ=-1.710459390585548E-01
    // auto moon = std::make_shared<IO::Astrodynamics::CelestialItem::CelestialBody>(301, "moon", earth);
    std::unique_ptr<IO::Astrodynamics::OrbitalParameters::OrbitalParameters> orbitalParams = std::make_unique<IO::Astrodynamics::OrbitalParameters::ConicOrbitalElements>(
            earth,
            10000000.0,
            0.3, 0.0,
            0.0, 0.0,
    ...
    IO::Astrodynamics::Propagators::Propagator pro(spc, integrator,
                                                   IO::Astrodynamics::Time::Window(startEpoch, endEpoch));
    ...
    ASSERT_DOUBLE_EQ(keplerResults.GetRightAscendingNodeLongitude(),
                     propagationResult.GetRightAscendingNodeLongitude());
...
TEST(Propagator, PropagateTLEIntegrator) {
    ...
    std::unique_ptr<IO::Astrodynamics::OrbitalParameters::OrbitalParameters> tle = std::make_unique<IO::Astrodynamics::OrbitalParameters::TLE>(
            earth, lines);
    IO::Astrodynamics::Time::TimeSpan step{60s};
    IO::Astrodynamics::Integrators::TLEIntegrator integrator(*tleIntegrator, step);
    IO::Astrodynamics::Body::Spacecraft::Spacecraft spc(-233, "issTLE", 1000.0, 3000.0, std::string(SpacecraftPath),
                                                        std::move(tle));
...
TEST(Propagator, CombinedManeuverAndPerigee) {
    auto earth = std::make_shared<IO::Astrodynamics::Body::CelestialBody>(399);
    auto moon = std::make_shared<IO::Astrodynamics::Body::CelestialBody>(301, earth);
    std::unique_ptr<IO::Astrodynamics::OrbitalParameters::OrbitalParameters> orbitalParams1 = std::make_unique<IO::Astrodynamics::OrbitalParameters::ConicOrbitalElements>(
            earth,
            5000000.0,
            0.5,
            1.0,
    ...
    IO::Astrodynamics::Body::Spacecraft::Spacecraft s{-1, "sptest", 1000.0, 10000.0, std::string(SpacecraftPath),
    ...
    forces.push_back(&gravityForce);
    IO::Astrodynamics::Integrators::VVIntegrator integrator(step, forces);
    IO::Astrodynamics::Propagators::Propagator prop(s, integrator, IO::Astrodynamics::Time::Window(
            IO::Astrodynamics::Time::TDB(668085555.829810s), IO::Astrodynamics::Time::TDB(668174400.000000s)));
    ...
    IO::Astrodynamics::Maneuvers::CombinedManeuver combineManeuver(engines, prop,
                                                                   s.GetOrbitalParametersAtEpoch()->GetInclination() +
                                                                   0.01,
                                                                   s.GetOrbitalParametersAtEpoch()->GetPerigeeVector().Magnitude() -
                                                                   1000.0);
    IO::Astrodynamics::Maneuvers::PerigeeHeightChangingManeuver perigeeHeightChangingManeuver(engines, prop,
                                                                                              s.GetOrbitalParametersAtEpoch()->GetPerigeeVector().Magnitude() -
                                                                                              1000.0 - 1000.0);
    combineManeuver.SetNextManeuver(perigeeHeightChangingManeuver);
    prop.SetStandbyManeuver(&combineManeuver);
    prop.Propagate();
