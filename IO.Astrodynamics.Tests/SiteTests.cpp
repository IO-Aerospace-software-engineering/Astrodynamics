...
TEST(Site, GetRADDec)
{
    ...
    IO::Astrodynamics::Sites::Site s{333002, "S2", IO::Astrodynamics::Coordinates::Geodetic(0.0, 45.0 * IO::Astrodynamics::Constants::DEG_RAD, 0.0), earth, std::string(SitePath)};
...
TEST(Site, FindDayWindows)
{
    auto sun = std::make_shared<IO::Astrodynamics::Body::CelestialBody>(10);
    auto earth = std::make_shared<IO::Astrodynamics::Body::CelestialBody>(399, sun);
    IO::Astrodynamics::Sites::Site s{333002, "S2", IO::Astrodynamics::Coordinates::Geodetic(2.2 * IO::Astrodynamics::Constants::DEG_RAD, 48.0 * IO::Astrodynamics::Constants::DEG_RAD, 0.0), earth, std::string(SitePath)};
...
TEST(Site, ConvertToLocalFrame)
{
    ...
    IO::Astrodynamics::Sites::Site s{399213, "FAKE_DSS-13",
                           IO::Astrodynamics::Coordinates::Geodetic(-116.7944627147624 * IO::Astrodynamics::Constants::DEG_RAD, 35.2471635434595 * IO::Astrodynamics::Constants::DEG_RAD, 107.0), earth,
                           std::string(SitePath)};
    auto sv = s.GetStateVector(*sun, IO::Astrodynamics::Frames::InertialFrames::GetICRF(), IO::Astrodynamics::AberrationsEnum::None, IO::Astrodynamics::Time::TDB("2021-05-18 12:00:00 TDB"));
...
TEST(Site, WriteEphemeris)
{
    auto sun = std::make_shared<IO::Astrodynamics::Body::CelestialBody>(10);
    auto earth = std::make_shared<IO::Astrodynamics::Body::CelestialBody>(399, sun);
    IO::Astrodynamics::Sites::Site s{399103, "S103", IO::Astrodynamics::Coordinates::Geodetic(2.2 * IO::Astrodynamics::Constants::DEG_RAD, 48.0 * IO::Astrodynamics::Constants::DEG_RAD, 0.0), earth,
                           std::string(SitePath)};
...
TEST(Site, ReadEphemeris)
{
    ...
    auto sun = std::make_shared<IO::Astrodynamics::Body::CelestialBody>(10);
    auto earth = std::make_shared<IO::Astrodynamics::Body::CelestialBody>(399, sun);
    IO::Astrodynamics::Sites::Site s{399102, "S102", IO::Astrodynamics::Coordinates::Geodetic(2.2 * IO::Astrodynamics::Constants::DEG_RAD, 48.0 * IO::Astrodynamics::Constants::DEG_RAD, 0.0), earth,
                           std::string(SitePath)};
...
TEST(Site, FindBodyVisibilityWindows)
{
    ...
    IO::Astrodynamics::Sites::Site s{399113, "FK_DSS-13",
                           IO::Astrodynamics::Coordinates::Geodetic(-116.7944627147624 * IO::Astrodynamics::Constants::DEG_RAD, 35.2471635434595 * IO::Astrodynamics::Constants::DEG_RAD, 1070.0), earth,
                           std::string(SitePath)};
