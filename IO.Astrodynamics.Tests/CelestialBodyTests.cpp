...
TEST(CelestialBody, FindDistanceConstraint)
{
	...
	auto results = earth->FindWindowsOnDistanceConstraint(searchWindow, *moon, *earth, IO::Astrodynamics::Constraints::RelationalOperator::GreaterThan(), IO::Astrodynamics::AberrationsEnum::None, 400000000.0, IO::Astrodynamics::Time::TimeSpan(86400s));
...
TEST(CelestialBody, FindOccultationConstraint)
{
	...
	auto results = earth->FindWindowsOnOccultationConstraint(searchWindow,*sun, *moon,IO::Astrodynamics::OccultationType::Any(), IO::Astrodynamics::AberrationsEnum::LT, IO::Astrodynamics::Time::TimeSpan(240s));
