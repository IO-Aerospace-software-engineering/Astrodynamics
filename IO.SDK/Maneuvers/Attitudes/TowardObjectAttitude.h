...
namespace IO::SDK::Maneuvers::Attitudes
{
    ...
    public:
         ...
         * @param targetBody 
         */
        TowardObjectAttitude(const std::vector<IO::SDK::Body::Spacecraft::Engine> &engines, IO::SDK::Propagators::Propagator &propagator, const IO::SDK::Body::Body &targetBody);
         ...
         * @param targetBody 
         */
        TowardObjectAttitude(const std::vector<IO::SDK::Body::Spacecraft::Engine> &engines, IO::SDK::Propagators::Propagator &propagator, const IO::SDK::Time::TDB &minimumEpoch, const IO::SDK::Body::Body &targetBody);
