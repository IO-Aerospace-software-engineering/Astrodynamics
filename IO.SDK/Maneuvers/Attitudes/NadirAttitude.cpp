...
void IO::SDK::Maneuvers::Attitudes::NadirAttitude::Compute(const IO::SDK::OrbitalParameters::OrbitalParameters UNUSED(&maneuverPoint))
{
...
bool IO::SDK::Maneuvers::Attitudes::NadirAttitude::CanExecute(const IO::SDK::OrbitalParameters::OrbitalParameters UNUSED(&orbitalParams))
{
    return true;
}