...
{
    return IO::SDK::OrbitalParameters::StateOrientation(maneuverPoint.GetStateVector().GetPosition().Normalize().Reverse().To(m_spacecraft.Front), IO::SDK::Math::Vector3D(0.0, 0.0, 0.0), maneuverPoint.GetEpoch(), maneuverPoint.GetFrame());
}
