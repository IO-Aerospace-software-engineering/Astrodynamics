...
{
    class RetrogradeAttitude : public IO::SDK::Maneuvers::ManeuverBase
    {
    private:
        /* data */
    ...
    public:
         ...
         * @param propagator 
         */
        RetrogradeAttitude(const std::vector<IO::SDK::Body::Spacecraft::Engine> &engines, IO::SDK::Propagators::Propagator &propagator);
         ...
         * @param minimumEpoch 
         */
        RetrogradeAttitude(const std::vector<IO::SDK::Body::Spacecraft::Engine> &engines, IO::SDK::Propagators::Propagator &propagator, const IO::SDK::Time::TDB &minimumEpoch);
