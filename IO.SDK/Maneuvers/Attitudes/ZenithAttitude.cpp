...
void IO::SDK::Maneuvers::Attitudes::ZenithAttitude::Compute(const IO::SDK::OrbitalParameters::OrbitalParameters UNUSED(&maneuverPoint))
{
...
bool IO::SDK::Maneuvers::Attitudes::ZenithAttitude::CanExecute(const IO::SDK::OrbitalParameters::OrbitalParameters UNUSED(&orbitalParams))
{
    return true;
}