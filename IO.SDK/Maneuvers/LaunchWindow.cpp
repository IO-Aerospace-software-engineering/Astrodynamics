...
IO::SDK::Maneuvers::LaunchWindow &IO::SDK::Maneuvers::LaunchWindow::operator=(const IO::SDK::Maneuvers::LaunchWindow &lw)
{
    ...
    const_cast<std::shared_ptr<IO::SDK::Sites::LaunchSite> &>(m_launchSite) = lw.m_launchSite;
...
const std::shared_ptr<IO::SDK::Sites::LaunchSite> &IO::SDK::Maneuvers::LaunchWindow::GetLaunchSite() const
{
    return m_launchSite;
}
