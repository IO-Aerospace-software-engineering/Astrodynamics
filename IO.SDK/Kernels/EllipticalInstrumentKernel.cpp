...
IO::SDK::Kernels::EllipticalInstrumentKernel::EllipticalInstrumentKernel(const IO::SDK::Instruments::Instrument& instrument, const IO::SDK::Math::Vector3D& boresight, const IO::SDK::Math::Vector3D& refVector, const double angle, const double crossAngle) 
	:InstrumentKernel(instrument, boresight, refVector, angle, "IKEllipticalTemplate.ti"), m_crossAngle{ crossAngle }
{
	BuildKernel();
