...
IO::SDK::Constraints::Parameters::OccultationParameters::OccultationParameters(const IO::SDK::Time::Window<IO::SDK::Time::TDB> &window, const IO::SDK::Body::Body &observer,
                                                                               ...
                                                                               const IO::SDK::Time::TimeSpan &initialStepSize) : m_window{window}, m_observer{observer},
                                                                                                                                 m_front{front},
