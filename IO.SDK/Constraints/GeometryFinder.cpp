                                                                      ...
                                                                      const Time::TimeSpan &stepSize)
{
    ...
    gfdist_c( std::to_string(targetId).c_str(), IO::SDK::Aberrations::ToString(aberration).c_str(), std::to_string(observerId).c_str(), constraint.ToCharArray(), value * 1E-03, 0.0,
...
std::vector<IO::SDK::Time::Window<IO::SDK::Time::TDB>>
IO::SDK::Constraints::GeometryFinder::FindWindowsOnOccultationConstraint(const IO::SDK::Time::Window<IO::SDK::Time::TDB> &searchWindow, int observerId,
                                                                         ...
                                                                         IO::SDK::AberrationsEnum aberration, const IO::SDK::Time::TimeSpan &stepSize)
{
    ...
    gfoclt_c(occultationType.ToCharArray(),  std::to_string(frontBodyId).c_str(), "ELLIPSOID", frontFrame.c_str(), std::to_string(targetBodyId).c_str(), targetShape.c_str(),
             targetFrame.c_str(), IO::SDK::Aberrations::ToString(aberration).c_str(), std::to_string(observerId).c_str(), stepSize.GetSeconds().count(), &cnfine, &results);
...
std::vector<IO::SDK::Time::Window<IO::SDK::Time::TDB>>
IO::SDK::Constraints::GeometryFinder::FindWindowsInFieldOfViewConstraint(const IO::SDK::Time::Window<IO::SDK::Time::TDB> &searchWindow, int observerId, int instrumentId,
                                                                         ...
                                                                         const IO::SDK::Time::TimeSpan &stepSize)
{
    ...
    gftfov_c(std::to_string(instrumentId).c_str(), std::to_string(targetId).c_str(), targetShape.c_str(), targetFrame.c_str(), IO::SDK::Aberrations::ToString(aberration).c_str(),
