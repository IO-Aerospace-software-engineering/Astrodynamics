...
IO::SDK::OrbitalParameters::TLE::TLE(const std::shared_ptr<IO::SDK::Body::CelestialBody> &centerOfmotion, std::string lines[3]) :  OrbitalParameters(centerOfmotion, std::chrono::duration<double>(0.0), IO::SDK::Frames::InertialFrames::GetICRF()),m_satelliteName{lines[0]}
{
	//Build lines
