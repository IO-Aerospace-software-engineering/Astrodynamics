...
IO::SDK::OrbitalParameters::EquinoctialElements::EquinoctialElements(const std::shared_ptr<IO::SDK::Body::CelestialBody> &centerOfMotion, const IO::SDK::Time::TDB &epoch,
                                                                     ...
                                                                     const double rightAscensionOfThePole, const double declinationOfThePole, const IO::SDK::Frames::Frames &frame)
...
IO::SDK::OrbitalParameters::EquinoctialElements::EquinoctialElements(const std::shared_ptr<IO::SDK::Body::CelestialBody> &centerOfMotion, const double semiMajorAxis,
                                                                     ...
                                                                     const double rightAscensionOfThePole, const double declinationOfThePole, const IO::SDK::Time::TDB &epoch,
                                                                     const IO::SDK::Frames::Frames &frame) : OrbitalParameters(centerOfMotion, epoch, frame),
