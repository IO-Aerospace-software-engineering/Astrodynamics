...
public class InstrumentPointingAttitudeTests
{
    ...
    void Create()
    {
        ...
        InstrumentPointingToAttitude attitude =
            new InstrumentPointingToAttitude(Time.MinValue, TimeSpan.FromHours(1.0), spc.Instruments.First(), TestHelpers.EarthAtJ2000, eng);
    ...
    public void Execute()
    {
        var orbitalParams = new StateVector(new Vector3(6678000.0, 0.0, 0.0), new Vector3(0.0, 7727.0, 0.0), TestHelpers.EarthAtJ2000, new Time(2021, 01, 01, 13, 0, 0),
            Frames.Frame.ICRF);
        ...
        InstrumentPointingToAttitude maneuver =
            new InstrumentPointingToAttitude(Time.MinValue, TimeSpan.FromSeconds(10.0), spc.Instruments.First(), TestHelpers.MoonAtJ2000, spc.Engines.First());
        ...
        Assert.Equal(new Window(new Time(2021, 01, 01, 13, 0, 0), TimeSpan.FromSeconds(10.0)), maneuver.ManeuverWindow);
        Assert.Equal(new Window(new Time(2021, 01, 01, 13, 0, 0), TimeSpan.Zero), maneuver.ThrustWindow);
    }
}