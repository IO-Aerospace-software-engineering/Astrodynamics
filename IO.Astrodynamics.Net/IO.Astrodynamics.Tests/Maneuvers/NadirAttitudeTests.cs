...
public class NadirAttitudeTests
{
    ...
    void Create()
    {
        ...
        NadirAttitude zenithAttitude = new NadirAttitude(TestHelpers.EarthAtJ2000,Time.MinValue, TimeSpan.FromHours(1.0), eng);
    ...
    public void Execute()
    {
        ...
        NadirAttitude maneuver = new NadirAttitude(TestHelpers.EarthAtJ2000,Time.MinValue, TimeSpan.Zero, spc.Engines.First());
