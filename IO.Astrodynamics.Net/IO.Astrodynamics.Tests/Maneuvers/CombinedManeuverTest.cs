...
namespace IO.Astrodynamics.Tests.Maneuvers
{
    public class CombinedManeuverTest
    {
        ...
        public void Create()
        {
            ...
            CombinedManeuver maneuver = new CombinedManeuver(TestHelpers.EarthAtJ2000,new Time(2021, 01, 01), TimeSpan.FromDays(1.0), 151000000.0, 1.0, eng);

            Assert.NotNull(maneuver.Engine);
            Assert.Equal(TimeSpan.FromDays(1.0), maneuver.ManeuverHoldDuration);
            Assert.Equal(new Time(2021, 01, 01), maneuver.MinimumEpoch);
        ...
        public void CanExecute()
        {
            ...
            var maneuver = new CombinedManeuver(TestHelpers.EarthAtJ2000,Time.MinValue, TimeSpan.Zero, spc.InitialOrbitalParameters.ApogeeVector().Magnitude() + 100000.0, 10.0,
                spc.Engines.First());
        ...
        public void TryExecuteIncreasePerigee()
        {
            ...
            var maneuver = new CombinedManeuver(TestHelpers.EarthAtJ2000,Time.MinValue, TimeSpan.Zero, 42164000.0, 0.0, spc.Engines.First());
            ...
            Assert.Equal(new Window(Time.Parse("2000-01-01T17:15:44.8323340").ToTDB(), Time.Parse("2000-01-01T17:16:52.7296418").ToTDB()), maneuver.ManeuverWindow);
            Assert.Equal(new Window(Time.Parse("2000-01-01T17:15:44.8323340").ToTDB(), Time.Parse("2000-01-01T17:16:52.7296418").ToTDB()), maneuver.ThrustWindow);
        ...
        public void TryExecuteDecreasePerigee()
        {
            ...
            var maneuver = new CombinedManeuver(TestHelpers.EarthAtJ2000,Time.MinValue, TimeSpan.Zero, 6600000.0, 0.0, spc.Engines.First());
            ...
            Assert.Equal(new Window(Time.Parse("2000-01-01T17:16:08.2299721").ToTDB(), Time.Parse("2000-01-01T17:16:40.9956911").ToTDB()), maneuver.ThrustWindow);
            Assert.Equal(new Window(Time.Parse("2000-01-01T17:16:08.2299721").ToTDB(), Time.Parse("2000-01-01T17:16:40.9956911").ToTDB()), maneuver.ManeuverWindow);
