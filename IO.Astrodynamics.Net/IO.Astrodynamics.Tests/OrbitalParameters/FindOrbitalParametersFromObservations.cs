...
public class FindOrbitalParametersFromObservations
{
    ...
    public void Create()
    {
        ...
        var mars = new CelestialBody(499);
        ...
        var orbitalParams =
            Astrodynamics.OrbitalParameters.OrbitalParameters.CreateFromObservation_Gauss(obs1.ToEquatorial(), obs2.ToEquatorial(), obs3.ToEquatorial(), site, Stars.SUN_BODY);
